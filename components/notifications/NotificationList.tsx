...
export function NotificationList({
  ...
  return (
    <Card className="bg-white border border-blue-fantastic/15 shadow-sm font-sans rounded-2xl">
            ...
            {visibleCount < notifications.length && (
              <div className="pt-2">
                <Button
                  ...
                  className="w-full bg-white border-blue-fantastic/15 text-blue-fantastic hover:bg-blue-fantastic/8 hover:border-blue-fantastic/25 font-sans font-semibold text-xs h-9 rounded-xl gap-1.5 shadow-2xs cursor-pointer"
                >
