...
import { Filter, Inbox, Bell, CheckCircle2, Receipt, Calendar, Wrench, ShieldAlert } from "lucide-react"
        ...
        {filterConfig.map(({ label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className={cn(
                "w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold font-sans transition-all duration-200 cursor-pointer",
                isActive
