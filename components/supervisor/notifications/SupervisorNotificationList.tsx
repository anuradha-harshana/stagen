...
export function SupervisorNotificationList({
  notifications,
  onToggleRead,
  onDelete,
  onUpdateNotification,
  onMarkAllAsRead,
}: SupervisorNotificationListProps) {
      ...
      <CardHeader className="border-b border-blue-fantastic/10 pb-3">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-blue-fantastic text-sm font-bold">
              Activity Feed
            </CardTitle>
            <Badge
              variant="outline"
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              className="text-xs font-semibold text-blue-fantastic/70 hover:text-blue-fantastic hover:bg-blue-fantastic/8 gap-1.5 h-7 px-2.5 rounded-xl cursor-pointer"
            >
      ...
      <CardContent className="pt-3 pb-4 space-y-2">
        {notifications.length === 0 ? (
          <div className="py-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-blue-fantastic text-sm font-bold">
              No notifications found
            </p>
            <p className="text-blue-fantastic/50 text-xs mt-1 max-w-xs">
...
export default SupervisorNotificationList
