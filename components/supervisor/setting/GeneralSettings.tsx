...
export default function GeneralSettings() {
  ...
  const [officeBranch, setOfficeBranch] = useState("Sydney Head Office (HQ)")
        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <option value="Brisbane Branch (QLD)">Brisbane Branch (QLD)</option>
              <option value="Adelaide Branch (SA)">Adelaide Branch (SA)</option>
              <option value="Perth Branch (WA)">Perth Branch (WA)</option>
            </select>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <option value="(ACST) Australia/Adelaide">(ACST) Australia/Adelaide</option>
