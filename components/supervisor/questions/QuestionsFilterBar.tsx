...
export function QuestionsFilterBar({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-white border border-blue-fantastic/15 p-3 rounded-2xl font-sans shadow-xs">
      {/* Status Pill Tabs */}
      ...
      <div className="flex items-center gap-2 self-end sm:self-auto">
        ...
        <select
          ...
          className="px-3 py-1.5 text-xs font-bold bg-white border border-blue-fantastic/20 rounded-xl text-blue-fantastic focus:border-truffle-trouble focus:ring-1 focus:ring-truffle-trouble outline-none cursor-pointer font-sans"
        >
          {CATEGORIES.map((cat) => (
