        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="px-4 py-2.5 rounded-xl border border-blue-fantastic/15 text-sm bg-white text-abyssal-blue focus:outline-none focus:ring-2 focus:ring-burning-flame/40"
            >
