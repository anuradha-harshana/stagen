...
export function TemplateEditor({
  ...
  if (!formData) {
    return (
      <div className="bg-white rounded-3xl p-12 border border-slate-200/80 flex flex-col items-center justify-center text-center font-cream h-full min-h-[400px]">
  ...
  return (
    <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm flex flex-col gap-6 font-cream">
      {/* Top Header Row */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-semibold text-xs transition-all shadow-xs"
          >
      ...
      {/* Live Preview Box */}
      {isPreviewOpen && (
        <div className="p-5 rounded-2xl bg-palladian/40 border border-oatmeal/60 flex flex-col gap-3 transition-all animate-in fade-in duration-200">
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 text-sm shadow-xs">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-sm text-abyssal-blue focus:outline-none focus:ring-2 focus:ring-burning-flame/40 focus:border-burning-flame transition-all"
        />
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-wrap gap-2 p-3 bg-slate-50 border border-slate-200/80 rounded-xl">
          {AVAILABLE_VARIABLES.map((v) => (
            <button
              ...
              className="px-2.5 py-1 bg-white border border-slate-200 rounded-lg text-xs font-mono text-slate-700 hover:border-burning-flame hover:bg-burning-flame/10 hover:text-abyssal-blue transition-all shadow-2xs"
            >
              {v.key}
            </button>
          ))}
        ...
        <textarea
          ...
          className="w-full p-4 rounded-2xl border border-slate-200 bg-white text-sm text-abyssal-blue focus:outline-none focus:ring-2 focus:ring-burning-flame/40 focus:border-burning-flame transition-all leading-relaxed font-sans"
        />
      </div>
    </div>
  )
